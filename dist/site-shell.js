...
(function(){"use strict";let t="";function o(){if(t)return t;const e=document.currentScript||document.querySelector('script[src*="site-shell"]');if(!e)return console.warn("site-shell: could not determine script base path"),"";const i=new URL(e.src);return t=i.href.substring(0,i.href.lastIndexOf("/")+1),t}function d(){return t}async function c(e){const i=await fetch(e);if(!i.ok)throw new Error("Failed to load site config");return i.json()}function s(e){return e?/^(https?:)?\/\//.test(e)||e.startsWith("/")?e:d()+e:""}function l(e,i,n){return`
  ...
  `}async function r(){const e=document.getElementById("site-header"),i=document.getElementById("site-footer");if(!e||!i)return;const n=e.dataset.config||s("config/site-config.json");e.dataset.base;const a=await c(n);e.innerHTML=l(a),i.innerHTML=u(a)}o(),document.readyState!=="loading"?r():document.addEventListener("DOMContentLoaded",r)})();
